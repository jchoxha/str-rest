...
orig = orig.replace("export default function GuestView() {", """export default function GuestView({ 
  propertiesData, 
  isPreviewMode = false, 
...
# Also add useEffect import
orig = orig.replace("import React, { useState } from 'react'", "import React, { useState, useEffect } from 'react'")

# Find the start of `return (` inside the component
return_index = orig.rfind('  return (\n    <div className="go-wrap">')
before_return = orig[:return_index]

# Add renderSection function before return
render_section_code = """
